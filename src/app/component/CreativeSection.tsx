...
const CreativeSection = () => {
  ...
  return (
    <section className="relative  sm:py-16   sm:px-4  md:py-24 md:px-6  via-zinc-900 to-black text-white overflow-hidden">
      ...
      >
        ...
        <div className="text-5xl md:text-7xl font-extrabold flex flex-wrap justify-center gap-5 items-center">
          <span className="text-[#6C54A0]" data-animate="left">creative</span>
        ...
        <div className="text-5xl md:text-7xl font-extrabold flex flex-wrap justify-center gap-5 items-center">
          ...
          <span className="text-[#6C54A0]" data-animate="right">minds</span>
          <Image src="/images/roundstart.png" alt="Round Star" width={72} height={72} className="rounded-full rotating-star shadow-xl" />
        </div>

        {/* Bottom Row */}
        <div className="text-5xl md:text-7xl font-extrabold flex flex-wrap justify-center gap-5 items-center">
          <span className="text-[#6C54A0]" data-animate="left">real</span>
          <div className="flex gap-3 items-center" data-animate="bottom">
            {middle.map((src, index) => (
              <Image key={index} src={src} alt={`Avatar ${index + 7}`} width={72} height={72} className="rounded-full shadow-lg" />
            ))}
          </div>
          <span className="text-[#6C54A0]" data-animate="right">results</span>
        </div>

        {/* Stats + Rotating Stars */}
        <div className="flex flex-wrap justify-center gap-12 items-center mt-10">
          <div className="border-1  p-6 rounded-full w-55" data-animate="scale">
            <div className="text-5xl font-bold" data-counter="5" data-unit="+">0+</div>
            <div className="text-sm mt-1 text-white">Years Experience</div>
          </div>

          <Image src="/images/stared.png" alt="Starred" width={72} height={72} className="rounded-full rotating-star" />

          <div className=" border-1 p-6 rounded-full w-55" data-animate="scale">
            <div className="text-5xl font-bold" data-counter="150" data-unit="+">0+</div>
            <div className="text-sm mt-1 text-white">Completed Projects</div>
          </div>
