      ...
      >
        ...
        {/* Glossy 3D Object */}
         <img
          ...
          className="absolute right-[-0%] top-[10%] w-[180px]    sm:w-[300px] md:w-[250px] lg:w-[550px] z-10 "
          alt="Throoy Logo"
        />
        {/* <video
            autoPlay
...
>
  ...
  >
    ...
    />
    <path
      d="M26.04 28.6199L18.5874 36.0725L11.1348 28.6199"
      stroke="white"
      stroke-width="2"
      stroke-linecap="round"
      stroke-linejoin="round"
 ...
 <motion.img
  ...
  className="
    absolute 
    bottom-[-60px] sm:bottom-[-80px] lg:bottom-[-100px]
    right-[-5%] sm:right-[-8%] lg:right-[-10%]
    max-w-[120px] sm:max-w-[200px] md:max-w-[250px] lg:max-w-[300px] xl:max-w-[300px]
    w-full h-auto 
    z-50
  "
  animate={{ rotate: 360 }}
